...
(setq org-directory "~/repos/github.com/villekauppila-solita/GTD/")
...
(after! vterm
  ;; (set-popup-rule! "*vterm*" :ignore t)) ;; Prevents vterm from opening in a popup
  (setq vterm-timer-delay 0.01))

(after! rustic
  (setq rustic-lsp-client 'lsp-mode)) ; or 'eglot if you prefer
